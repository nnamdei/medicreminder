...
int alarmId;
   ...
   boolean checked;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_newmedicine);
        ...
        NameMedicine=(EditText) findViewById(R.id.Name_medicine);
    ...
    for (int k = 0; k < Newrecord.getDosage()-1; k++) {
        ...
        setalarmclock(NewDate,alarmId);
         ...
         Toast.makeText(getApplicationContext(),
                "Open All Medications to save.", Toast.LENGTH_LONG).show();
         }
         catch(Exception e)
         {
         Toast.makeText(getApplicationContext(),
...
public void timepickershow(){// Process to get Current Time
    ...
    public  void setalarmclock(Calendar calparam,int id)
    {
        ...
        Intent myIntent = new Intent(NewMedicine.this, AlarmReceiver.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(NewMedicine.this, id,myIntent, 0);
